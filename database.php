    	...
    	<div class="row">
    		...
    		<div id="sponsor-support-footer" class="col-md-5">
                ...
                <ul class="text-center">
                    ...
                    <!-- <li><img class="sponsor" src="http://www.isauw.org/img/asuw-logo2.jpg" alt="ASUW"></li> -->
                    <!-- <li>
                        <img class="sponsor" src="http://www.isauw.org/img/absolute.png">
                    </li>
                    <li>
                        <img class="sponsor" src="http://www.isauw.org/img/ellips.png">
                    </li>
                    <li>
                        <img class="sponsor" src="http://www.isauw.org/img/ovale.png">
                    </li> -->
                </ul>
                <div class="row Separate">
		  				<div class="col-md-4"><hr></div>
                ...
                <ul class="text-center">
                    ...
                    <!-- <li>
                        <img src="http://www.isauw.org/img/seac.png">
                    </li> -->
                </ul>
            </div>
    	</div>
