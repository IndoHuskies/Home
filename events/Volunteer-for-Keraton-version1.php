    	...
    	<div id="event-info" class="row">
    		<div class="row featurette">
    			...
    			<div class="col-md-10">
                        ...
                        <ul>
                            ...
                            <li class="volunteer-desc">
                                <div class="panel panel-info">
                                    ...
                                    <div class="panel-body">
                                        <ul style="list-style:disc;">
                                            <li>Able to come at assigned time during the day (early in the morning)</li>

                                            <li>Understand and perform duties assigned to them</li>

                                            <li>Help to setup decoration materials</li>

                                            <li>Loading and unloading things</li>
                                        </ul>
                                        <h4 style="text-decoration:underline;">Requirement</h4>

                                        <ul>
                                            <li>Friendly, helpful, and responsible</li>
                                        </ul>
                                    </div>
                                </div>
                            </li>
                            <li class="volunteer-desc">
                                <div class="panel panel-info">
                                    ...
                                    <div class="panel-body">
                                        <ul style="list-style:disc;">
                                            <li>Help to clean up the venue after the event ends</li>

                                            <li>Taking care of all decoration materials and other equipment</li>
                                        </ul>
                                        <h4 style="text-decoration:underline;">Requirement</h4>
                    ...
                    <div class="row lead">
                        <form class="col-md-12 form-horizontal" id="volunteer-form" method="POST" action="keraton-2015-volunteer.php">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8" id="inputWork">
                                    <select id="work1" name="vol_1" class="form-control">
                                        ...
                                        <option value="cleaning">Event Clean Up</option>
                                    </select>
                                    ...
                                    <select id="work4" name="vol_4" class="form-control">
                                        <option disabled selected> -- select an option -- </option>
                                        <option value="usher">Usher</option>
                                        <option value="event-photo">Event Photographer</option>
                                        <option value="vendor">Food Vendor Asistant</option>
                                    ...
                                    <select id="work5" name="vol_5" class="form-control">
                                        <option disabled selected> -- select an option -- </option>
                                        <option value="usher">Usher</option>
                                        <option value="event-photo">Event Photographer</option>
                                        <option value="vendor">Food Vendor Asistant</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="number" name="hour" class="form-control" id="inputHour" min="1" max="24" style="max-width:10%;">
                                </div>
                            </div>
...
<?php footer($conn); ?>
  ...
  $(document).ready(function (){
    ...
    $('#inputWork #work1, #inputWork #work2, #inputWork #work3, #inputWork #work4, #inputWork #work5').change(validate);
    ...
    $("#volunteer-form").submit(function(e) {
        ...
        $.ajax({
            url: 'keraton-2015-volunteer.php',
            type: 'POST',
            data: formData
        }).done(function( msg ) {
