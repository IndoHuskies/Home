<?php
    ...
    $event_name = "UW Indonesian Gathering";
    	...
    	<div id="event-info" class="row">
    		<div class="row featurette">
    			...
    			<div class="col-md-10">
    				...
    				<div id="event-img">
    					<img class="featurette-image img-responsive img-circle" src="../<?php echo $result->media ?>" alt="Generic placeholder image">
    				</div>

    				<p class="lead" id="event-detail">
    					<strong>Date: </strong><span id="date"></span>
    					<br>
    					<strong>Time: </strong><?php echo $result->time ?>
    					<br>
